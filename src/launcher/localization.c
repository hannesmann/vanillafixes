...
static LPCWSTR* g_Languages[VF_LANG_COUNT] = {
    /* VF_LANG_ENGLISH */ g_EnglishStrings,
    /* VF_LANG_RUSSIAN */ g_RussianStrings
};

// Current selected language
static int g_CurrentLanguage = VF_LANG_ENGLISH;
...
void LocalizationInit(void) {
    ...
    switch (primaryLangId) {
        case 0x19: /* LANG_RUSSIAN */
            g_CurrentLanguage = VF_LANG_RUSSIAN;
            break;
        default:
            g_CurrentLanguage = VF_LANG_ENGLISH;
            break;
    }
}
